...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/object@v0.0.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/object/actions/workflows/test.yml/badge.svg?branch=v0.0.1
[test-url]: https://github.com/stdlib-js/object/actions/workflows/test.yml?query=branch:v0.0.1
